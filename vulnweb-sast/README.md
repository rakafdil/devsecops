...
# Detailed PHP security scan
semgrep --config=p/php --config=p/owasp-top-ten src/
```

### Scan Results Summary
- **Total Findings**: 33 vulnerabilities
- **Critical (ERROR)**: 31 findings (94%)
  - SQL Injection: 10 instances
  - Cross-Site Scripting (XSS): 21 instances
- **High (WARNING)**: 2 findings (6%)
  - Server-Side Request Forgery (SSRF): 2 instances

### Documentation
- 📖 [Tutorial Lengkap](SAST-SEMGREP-TUTORIAL.md) - How-to dan best practices
- 📊 [Laporan Lengkap](SAST-REPORT.md) - Detailed vulnerability report
- 📋 [Quick Summary](SCAN-SUMMARY.md) - Executive summary
- 🚀 [Command Cheatsheet](SEMGREP-CHEATSHEET.md) - Quick reference

### Most Vulnerable Files
1. `src/orders.php` - 10 findings
2. `src/products.php` - 8 findings  
3. `src/comments.php` - 6 findings
4. `src/admin.php` - 5 findings
5. `src/register.php` - 3 findings
